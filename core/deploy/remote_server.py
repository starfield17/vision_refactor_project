...
from core.deploy.edge_common import append_stats_snapshot
from core.infer.factory import create_frame_inferencer
from core.model_manifest import resolve_model_identity
from core.transport.frame_http import decode_jpeg_base64, encode_jpeg_base64
from core.transport.stats_http import push_stats_event
from common.types.detection import Detection
from common.types.errors import ConfigError, DataValidationError, TransportError
