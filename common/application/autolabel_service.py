...
from common.application.common import (
    append_override,
...
from common.config.editing import persist_config_overrides
...
def build_autolabel_overrides_from_payload(payload: dict[str, Any]) -> list[str]:
    ...
    append_override(overrides, "runtime.mode", payload.get("mode"))
    append_override(overrides, "runtime.confidence", payload.get("confidence"))
    append_override(overrides, "runtime.batch_size", payload.get("batch_size"))
    append_override(overrides, "runtime.visualize", payload.get("visualize"))
    append_override(overrides, "runtime.on_conflict", payload.get("on_conflict"))

    append_override(overrides, "runtime.model.backend", payload.get("model_backend"))
    append_override(overrides, "runtime.model.onnx_model", payload.get("model_onnx"))

    append_override(overrides, "runtime.llm.base_url", payload.get("llm_base_url"))
    append_override(overrides, "runtime.llm.model", payload.get("llm_model"))
    append_override(overrides, "runtime.llm.api_key", payload.get("llm_api_key"))
    append_override(
        overrides,
        "runtime.llm.api_key_env_name",
        payload.get("llm_api_key_env_name"),
    )
    append_override(overrides, "runtime.llm.prompt", payload.get("llm_prompt"))
    append_override(overrides, "runtime.llm.timeout_sec", payload.get("llm_timeout_sec"))
    append_override(overrides, "runtime.llm.max_retries", payload.get("llm_max_retries"))
    append_override(
        overrides,
        "runtime.llm.retry_backoff_sec",
        payload.get("llm_retry_backoff_sec"),
    )
    append_override(overrides, "runtime.llm.qps_limit", payload.get("llm_qps_limit"))
    append_override(overrides, "runtime.llm.max_images", payload.get("llm_max_images"))
