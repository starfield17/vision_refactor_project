...
def build_train_overrides_from_payload(payload: dict[str, Any]) -> list[str]:
    ...
    append_override(overrides, "runtime.backend", payload.get("backend"))
    append_override(overrides, "runtime.device", payload.get("device"))
    append_override(overrides, "runtime.seed", payload.get("seed"))
    append_override(overrides, "runtime.epochs", payload.get("epochs"))
    append_override(overrides, "runtime.batch_size", payload.get("batch_size"))
    append_override(overrides, "runtime.img_size", payload.get("img_size"))
    append_override(overrides, "runtime.dry_run", payload.get("dry_run"))

    append_override(overrides, "runtime.yolo.weights", payload.get("yolo_weights"))
