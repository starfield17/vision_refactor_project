...
from core.kernel import RunResult
...
def build_train_registry() -> KernelRegistry:
    from core.trainer.faster_rcnn import run_faster_rcnn_train
    from core.trainer.yolo import run_yolo_train
...
def build_autolabel_registry() -> KernelRegistry:
    from core.autolabel.llm_autolabel import run_llm_autolabel
    from core.autolabel.locate_anything_autolabel import run_locate_anything_autolabel
    from core.autolabel.model_autolabel import run_model_autolabel
