"""Worker process for autolabel jobs."""
...
from common.application.autolabel_service import run_autolabel
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Autolabel worker subprocess")
